...
::-n                指定文件名
pyinstaller.exe --clean -y -F -i favicon.ico --version-file file_version_info.txt -n xuanwu-oa-xml2json zhiyuan_oa_xml_for.py

::运行方式2：用spec生成
::pyinstaller.exe xuanwu-excel2json.spec

pandoc README.md  -o .\dist\xuanwu-oa-xml2json使用说明.docx
